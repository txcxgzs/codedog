<template>
  <div class="admin-shell">
    <aside><div class="logo">编程狗<span>IM 管理后台</span></div><nav><button class="active">聊天审计</button><button>举报处理</button><button>群聊管理</button><button>在线状态</button><button>系统设置</button></nav><small>编程狗即时通讯 v0.1</small></aside>
    <main>
...
.group-limit div { display:grid; gap:4px; }.group-limit small { color:#93845e; }
.group-limit input { height:37px; min-width:0; border:1px solid #e2d7b8; border-radius:8px; background:#fff; color:#30343a; padding:0 10px; }
