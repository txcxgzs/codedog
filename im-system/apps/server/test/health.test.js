...
test('SSO user profiles are stored and refreshed', async () => {
  ...
  await UserProfile.upsert({ id: 81, username: 'codedog_81', nickname: '编程狗用户', avatar: 'https://example.test/avatar.png', role: 'user' });
  await UserProfile.upsert({ id: 81, username: 'codedog_81', nickname: '新昵称', avatar: 'https://example.test/new.png', role: 'user' });
