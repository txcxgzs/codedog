...
@media(max-width:768px){
  ...
  .mobile-nav__create{position:absolute;left:41.6667%;top:-14px;transform:translateX(-50%);width:16.6667%;min-height:0;padding:0;border:0;background:transparent;color:#172033;font:700 10px/1 sans-serif;display:flex;flex-direction:column;align-items:center;gap:3px}
